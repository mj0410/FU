...
cnn_bilstm = create_model(units=params['units'], neurons=params['neurons'], activation=params['activation'], filters=params['filters'])

history = cnn_bilstm.fit(x_train, y_train, epochs = 10, validation_split = 0.2, verbose=2)

score = cnn_bilstm.evaluate(x_test, y_t, verbose=0)

"""precision-recall curve"""

probs = cnn_bilstm.predict(x_test)[:,1]
