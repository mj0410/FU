...
Original file is located at
    https://colab.research.google.com/drive/1-uBAdYW1WS8K1REnDgxKYTit_BWuxvAv
"""
...
from keras.layers import Dropout, Activation, Flatten, Conv1D, MaxPooling1D
...
plt.title('CNN-LSTM Precision-Recall Curve (AUC = ' + str(round(pr_auc,4)) + ')')
...
plt.plot(fpr, tpr)
plt.title('CNN-LSTM ROC Curve (AUC = ' + str(round(auc,4)) + ')')
