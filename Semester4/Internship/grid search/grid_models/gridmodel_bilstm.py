...
bilstm = create_model(units=params['units'], neurons=params['neurons'], activation=params['activation'])
history = bilstm.fit(x_train, y_train, epochs = 10, validation_split = 0.2, verbose=2)

score = bilstm.evaluate(x_test, y_t, verbose=0)

"""precision-recall curve"""

probs = bilstm.predict(x_test)[:,1]
