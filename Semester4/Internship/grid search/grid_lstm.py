...
def create_model(units=10, neurons=10, activation='relu'):
    # create model
    model = Sequential()
    model.add(LSTM(units, input_shape=(20, 5), return_sequences=True))
...
param_grid = dict(units=units, epochs=epochs, neurons=neurons, activation=activation)
