...
def visualization(seq, seq_val, method, prob, actual, num_for_figtitle):
  title = ['w_TP.png', 'w_FN.png', 'w_FP.png', 'w_TN.png', 'wo_TP.png', 'wo_FN.png', 'wo_FP.png', 'wo_TN.png', 'CNN-LSTM1.png', 'CNN-LSTM1.png']
  ...
  plt.savefig('cnn_lstm/'+title[num_for_figtitle])
...
innv_df = save_data(innv_df)
innv_df.to_pickle('CNN-LSTM_innv.pkl')
